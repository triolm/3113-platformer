...
enum Direction    { LEFT, UP, RIGHT, DOWN, UPLEFT, UPRIGHT }; // For walking
...
private:
    ...
    void checkCollisionDeadlyTile(Map *map);
...
public:
    ...
    bool        onDeadlyTile()             const { return mOnDeadlyTile;          }
